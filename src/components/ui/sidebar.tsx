...
import { PanelLeft, ChevronLeft, ChevronRight, Lock, Unlock, Search } from "lucide-react"
...
const SidebarToggle = () => {
    ...
    return (
        <div className="absolute bottom-8 z-50 group-data-[side=left]:-right-4 group-data-[side=right]:-left-4 transition-opacity">
            <Button
                variant="ghost"
                size="icon"
